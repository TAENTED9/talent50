...
export default function Hero() {
  return <section id="home" className="relative flex min-h-screen items-end overflow-hidden bg-ink pb-[clamp(48px,7vh,96px)]">
    <div className="absolute inset-[-12%_0] bg-[#121310] grayscale-[.25]" /><div className="absolute inset-0 bg-hero-overlay" /><div aria-hidden="true" className="pointer-events-none absolute -right-24 -top-24 z-0 h-96 w-96 animate-float rounded-full bg-accent/10 blur-3xl" /><div aria-hidden="true" className="pointer-events-none absolute -left-32 top-1/3 z-0 h-80 w-80 rounded-full bg-accent/5 blur-3xl" />
