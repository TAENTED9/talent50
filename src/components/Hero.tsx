  ...
  return (
    <section id="home" className="relative flex min-h-screen items-end overflow-hidden bg-ink pb-[clamp(48px,7vh,96px)]">
      <div className="absolute -top-[12%] left-0 right-0 bottom-0">
        <Image src="/assets/hero.jpg" alt="Talent50 Company — African sport" fill priority quality={90} sizes="100vw" className="object-cover grayscale-[.25]" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex h-[530px] w-full max-w-content animate-fade-up flex-col justify-end px-5 md:px-[5vw] lg:px-[72px]">
        <div className="mb-[26px] font-mono text-[11px] uppercase tracking-[0.14em] text-text-light/60">Talent50 Company</div>
        ...
        <p className="mb-10 max-w-[58ch] text-[clamp(17px,1.4vw,21px)] font-light leading-[1.55] text-muted-light">The Talent50 Company unlocks the value of African sports, turning potential into assets.</p>
