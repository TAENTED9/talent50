						...
						<div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center">
							...
							<div>
								<div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-[18px]">
									...
									<a href="mailto:hello@thetalent50company.com" className="break-words border-b border-paper/30 pb-0.5 text-sm text-muted-light transition-colors duration-300 hover:border-accent hover:text-accent focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-accent focus-visible:outline-offset-2">hello@thetalent50company.com</a>
								</div>
							</div>
						</div>
					</div>
