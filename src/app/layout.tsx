...
export const metadata: Metadata = {
  ...
  title: 'The Talent50 Company | Building the Missing Middle of African Sport',
  description:
    'Talent50 Company unlocks the value of African sports by building teams, media, and technology that keep value on the continent.',
  keywords: ['Talent50', 'African sport', 'sports tech', 'sports media'],
  icons: { icon: '/assets/logo-ink.png' },
  openGraph: {
    title: 'The Talent50 Company',
    description: 'Building the missing middle of African sport.',
    type: 'website',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Talent50 Company',
    description: 'Building the missing middle of African sport.',
  },
};
